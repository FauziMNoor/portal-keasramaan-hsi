      ...
      <main className="flex-1 p-3 sm:p-6 lg:p-8 pt-20 lg:pt-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-4 sm:mb-6 lg:mb-8">
            <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-800 mb-1 sm:mb-2">Rekap Perizinan Kepulangan</h1>
            <p className="text-sm sm:text-base text-gray-600">Monitoring izin kepulangan santri dengan countdown dinamis</p>
          </div>
          ...
          <div className="mb-4 sm:mb-6 flex flex-wrap gap-2 sm:gap-3">
            ...
            <button
              onClick={exportToCSV}
              className="ml-auto bg-green-600 hover:bg-green-700 text-white px-4 sm:px-6 py-2 rounded-lg text-sm sm:text-base font-semibold flex items-center gap-2 transition-colors"
            >
                    ...
                    <div key={item.id} className="p-4">
                      ...
                      <div className="flex items-start justify-between mb-3">
                        <div className="flex-1">
                          ...
                          <p className="text-xs text-gray-500">{item.nis} • {item.kelas} • {item.cabang}</p>
                        </div>
                        <div className="ml-2">
                          {getStatusBadge(item.status)}
                        </div>
                      ...
                      <div className="space-y-2 mb-3">
                        ...
                        <div className="flex items-start text-sm">
                          ...
                          <span className="text-gray-600 text-xs">{item.alasan}</span>
                        </div>
                      </div>
          ...
          <div className="mt-4 sm:mt-6 bg-blue-50 border border-blue-200 rounded-xl p-3 sm:p-4">
            <h3 className="font-semibold text-blue-800 mb-2 text-sm sm:text-base">Keterangan Sisa Waktu:</h3>
